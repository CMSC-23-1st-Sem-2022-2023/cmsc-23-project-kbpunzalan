...
void main() {
  ...
  testWidgets('Test Login Widget', (WidgetTester tester) async {
    ...
    await tester.enterText(passwordField, "11111Aa-");
    ...
    //! expected to cause an error for all pasword errors since it is not expected
    expect(passwordError1, findsOneWidget);
